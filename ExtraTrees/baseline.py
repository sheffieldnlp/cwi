...
class Baseline(object):
    ...
    def extract_features(self, word,sent):
        ...
        return [str(len_chars),str(len_tokens),str(senses),str(sylable),str(unigram_prob)]#, str(vowel_sums) ,str(consonant_sums)]#,str(unigram_prob) ,str(stop_word),str(noun),str(syn_count),str(syn_count2)]
