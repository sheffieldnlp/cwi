...
class Baseline(object):
    ...
    def extract_features(self, word,sent):
        ...
        return [str(len_chars),str(len_tokens),str(senses),str(sylable),str(unigram_prob), str(consonant_sums) ,str(vowel_sums),str(stop_word)]
    ...
    def test(self, testset):
        ...
        return self.model.predict(np.array(X,object)) #self.rnd_search.predict(X).round() 
